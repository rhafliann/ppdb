        ...
        <div class="col-lg-12">
            <div class="intro-text">
                ...
                <h4 class="text-danger"><br><br><br>
                    <img src="img/logosesat.png" width="60">
                    Login Administrasi
                </h4>
                <div class="col-md-12">
                    <span class="text-warning">Masukkan No. Pendaftaran dan Password<br> yang diperoleh saat melakukan pendaftaran secara online.</span><br>
                </div>
