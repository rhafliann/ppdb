...
<head>
  ...
  <title>PPDB Online | SMA SEJAHTERA 1 DEPOK</title>
  <link rel="icon" href="assets/images/logosesat.png" type="image/x-icon" />
...
<body class="fixed-topbar sidebar-hover theme-sltl color-green">
  <section>
    <div class="main-content">
      <!-- BEGIN TOPBAR -->
      <div class="topbar" style="background-color: #061536; color: #fff;">
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          <div class="header" style="margin-top:-20px; text-align: center;">
            <img src="img/logosesat.png" style="margin-bottom:10px;" width="100"><br>
            <h2 align="center">FORM PENDAFTARAN PPDB ONLINE <strong> <br>SMA SEJAHTERA 1 DEPOK</strong></h2>
                              ...
                              <div class="panel">
                                ...
                                <div class="panel-body">
                                  <span style="font-size:15px">
                                    <p align="center">Proses pendaftaran PPDB Online SMA SEJAHTERA 1 DEPOK hampir selesai. <br>Silakan periksa kembali data-data yang sudah anda masukkan.</p><br><br>
                                    <div class="col-md-12">
            ...
            <div class="footer">
              <div class="copyright">
                <p class="pull-left sm-pull-reset">
                  <span>Copyright &copy; <a href="#" target="_blank">SMA SEJAHTERA 1 DEPOK</a> <?php echo date('Y'); ?></span>
                </p>
