...
<head>
    ...
    <link rel="shortcut icon" href="img/logosesat.png" type="image/png">
    <!-- Bootstrap Core CSS -->
...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">
                    <img src="img/logosesat.png" alt="Logo" width="35" style="position:absolute;margin-top:-10px;">
    ...
    <header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-responsive" src="img/logosesat.png" style="margin-top:-15%;margin-bottom:-10px;" width="100">
                    <br><br>
                    <div class="intro-text">
                        ...
                        <?php if ($web_ppdb->status_ppdb == 'buka') { ?>
                            <span>
                                <a href="pendaftaran" class="btn btn-primary" style="margin: 5px; border-radius: 6px;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12" style="margin-top:-10px;">
                    ...
                    <div class="col-md-8">
                        <img class="img-responsive" src="img/alur.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2" style="text-align:justify; line-height: 22px;">
                    <p>SMA Sejahtera 1 Depok menyediakan PPDB secara <i>online</i> diharapkan proses PPDB dapat berjalan cepat
                        dan bisa dilakukan dimanapun dan kapanpun selama sesi PPDB Online dibuka. Proses pendaftaran calon siswa baru di masa pandemi Covid-19 ini dan terhambat oleh jarak jika datang ke sekolah langsung, bisa mengakses website PPDB Online SMA Sejahtera 1 Depok. </p>
                </div>
                ...
                <div class="col-lg-8 col-lg-offset-2 text-center page-scroll">
                    <a href="#page-top" class="btn btn-primary" style="border-radius: 5px;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12" style="margin-top:-10px;">
                    <div class="col-md-2"></div>
                    <div class="col-md-8">
                        <img class="img-responsive" src="img/syarat.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
