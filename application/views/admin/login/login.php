...
<form action="" method="post">
	<div class="panel panel-body login-form">
		<div class="text-center">
			<img src="img/logosesat.png" alt="Logo" width="80">
			<h5 class="content-group">LOGIN ADMIN PPDB Online<small class="display-block"><b>SMA SEJAHTERA 1 DEPOK</b></small></h5>
			<?php
