...
<body onload="window.print();">
  ...
  <br>
  <h4 align="center" style="margin:0px;font-size:19px;"><u><b>SURAT PENGUMUMAN</b></u></h4>
  <center>
  ...
  <table width="100%" border="0">
    <tr>
      <td colspan="3">Kepala SMA SEJAHTERA 1 DEPOK dengan ini menyatakan bahwa :</td>
    </tr>
    <tr>
  ...
  VERIFIKASI dan SELEKSI Sebagai Calon Peserta Didik SMA Sejahtera 1 Depok tahun ajaran <?php echo $thn_ppdb; ?>/<?php echo $thn_ppdb + 1; ?>.<br>
  ...
  <div style="float:right;">
    ...
    <b><u>Handoko Budi Setiawan, S.Pd</u></b><br>
