			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown dropdown-user">
					<a class="dropdown-toggle" data-toggle="dropdown">
						<img src="img/logosesat.png" alt="foto">
						<span>SMA Sejahtera 1 Depok</span>
						<i class="caret"></i>
					</a>
				...
				<div class=" sidebar-content">
					...
					<div class="sidebar-category sidebar-category-visible" style="background-color: white;">
						...
						<div class="category-content sidebar-user">
							<div class="media">
								<a href="panel_siswa/biodata" class="media-left"><img src="img/logosesat.png" class="img-flat img-sm" alt="foto"></a>
								<div class="media-body">
									<div class="text-size-mini text-muted">
										<i class="icon-user text-size-small"></i> &nbsp;<b><?php echo $level; ?></b>
									</div>
									<span class="media-heading text-semibold">SMA Sejahtera 1 Depok</span>
								</div>
							</div>
						</div>
