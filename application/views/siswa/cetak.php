...
<head>
  ...
  <link rel="icon" type="image/png" href="img/logosesat.png" />
  <style>
    table {
...
<body onload="window.print();">
  ...
  <b>
    <center>
      PANITIA PENERIMAAN PESERTA DIDIK BARU (PPDB) <br>
        SMA SEJAHTERA 1 DEPOK TAHUN PELAJARAN <?php echo $id['th_pelajaran']; ?></center>
  </b>
  <br>
  ...
  <div style="float:right;">
    Depok, <?php echo $this->lib_data->tgl_id(date('d-m-Y')); ?> <br>
    Ketua Panitia PPDB, <br>
    <img src="img/ttd.png" alt="" width="100"><br>
    <b><u>Dra. Ira Anita</u></b><br>
  ...
  <table width="100%" border="0" style="margin-left:5px;">
    ...
    <tr>
      <td valign="top">5.</td>
      <td colspan="3">Semua berkas dimasukan kedalam map biru (PUTRA), map Kuning (PUTRI) dan diserahkan kepada Panitia PPDB SMA Sejahtera 1 Depok Tahun Pelajaran <?php echo $id['th_pelajaran']; ?></td>
    </tr>
  </table>
